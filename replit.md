...
- July 07, 2025. Implemented Version 2 navigation structure with organized dropdown menus: created hierarchical navigation with For Merchants (Apply Now, How It Works, FAQ), For Brokers (Submit Deal, Requirements, ISO FAQ), For Investors (Why InvestoFund, Example Returns, Request Info), About Us, and Contact/Login sections; updated header with dropdown functionality and mobile-responsive design; created comprehensive merchant application pages with detailed forms, process explanations, and FAQ sections; added broker deal submission portal with commission tracking