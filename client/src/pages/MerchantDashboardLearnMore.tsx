...
export default function MerchantDashboardLearnMore() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-brand-blue to-brand-blue-light text-white py-20">
          ...
          <Card className="bg-gradient-to-r from-green-50 to-blue-50 border-2 border-green-200">
            <CardContent className="p-8">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                ...
                <span className="font-semibold text-green-700"> Within 48 hours.</span>
              </p>
            </CardContent>
          </Card>
        </div>
          ...
          <Card className="bg-white shadow-xl">
            <CardContent className="p-8">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h3 className="text-2xl font-bold text-gray-900">Real Merchant Story: Bob's Journey</h3>
                  <p className="text-gray-600">Manufacturing Business Owner</p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-semibold text-gray-900">Bob Richardson</p>
                  <p className="text-sm text-gray-600">Richardson Manufacturing, Texas</p>
                </div>
      ...
      {/* Final CTA */}
      <section id="apply-form" className="py-20 bg-gradient-to-br from-brand-blue to-brand-blue-light text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
